    ...
    public FormInfo execute(CommandContext commandContext) {
        ...
        if (processDefinitionEntity.hasStartFormKey()) {
            ...
            if (formHandler.getFormKey() != null) {
                ...
                formInfo.setActivityId(processDefinitionEntity.getInitial().getId());
            }
        } else {
            ...
            if (startActivity.getOutgoingTransitions().size() != 1) {
                throw new IllegalStateException("start activity outgoing transitions cannot more than 1, now is : "
