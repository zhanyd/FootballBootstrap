...
<html lang="en">
  ...
  <head>
	...
	<link href="${ctx}/plugin/bootstrap/css/bootstrap-responsive.min.css" rel="stylesheet">
	...
	<div id="targetContentDiv">
	  <div class="container">
		...
		<ul>
		  ...
		  <li><a class="btn btn-primary" href="${ctx}/j_spring_security_logout"><spring:message code="core.403.logout" text="注销"/></a></li>
		</ul>
      </div>
	</div>
